...
def create_dataset(dataset, config, min_scale=0.5):
    ...
    if dataset=='pretrain':
        ...
        train_dataset = coco_karpathy_train(transform_train, prompt=config['prompt'])
        val_dataset = coco_karpathy_caption_eval(transform_test, 'val')
        test_dataset = coco_karpathy_caption_eval(transform_test, 'test')   
